  ...
  return <>
    <div className="bg-bluebg text-white p-12 flex flex-col items-center gap-y-4 leading-8 ">
      <div className="max-w-lg">
        <h1 className="text-3xl mb-12">VISION</h1>
      ...
      <div className="max-w-lg">
        <h1 className="text-3xl my-12">MISSION</h1>
      ...
      <div className="max-w-lg">
        ...
        <h1 className="text-3xl my-12">STRATEGY</h1>
...
function Portfolio() {
  return <>
    <div className="p-12 flex flex-col items-center gap-y-4 leading-8 ">
      ...
      <div className="max-w-lg border-2 p-5">
...
function ContactUs() {
  return <>
    ...
    <div className="p-12 flex flex-col gap-y-4 leading-8 bg-bluebg text-white justify-center items-center">
    ...
    <div className="p-12 flex flex-col gap-y-4 bg-bluebg text-white justify-center items-center">
      <div className="max-w-lg w-full">
        <h1 className="mb-4 text-center  font-bold ">
          OUR OFFICE
        </h1>
